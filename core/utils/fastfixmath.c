...
{
  //return (int)(((long long int)a * b) / FFM_UNIT); // result ff
  return (int)(((long long int)a * b) / (FFM_UNIT * FFM_UNIT)); // result int
}

int ffm_div(int a, int b)
{
  return (int)((((long long int)a) * FFM_UNIT) / b); // result ff
  //return (int)((((long long int)a) * FFM_UNIT) / b / FFM_UNIT); //result int
}
